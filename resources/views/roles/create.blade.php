...
@if (count($errors) > 0)
    <div class="alert alert-danger">
        <strong>Whoops doopsie!</strong> There were some problems with your input.<br><br>
        <ul>
...
<p class="text-center text-primary"><small>Tutorial by glensolutions.com</small></p>
@endsection